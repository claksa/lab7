...
public class CommandNet  implements Serializable {
    ...
    public CommandNet(String[] enteredCommand){
        ...
        if (enteredCommand[0].equals("add") | enteredCommand[0].equals("remove")|enteredCommand[0].equals("addmin") | enteredCommand[0].equals("update") | enteredCommand[0].equals("removelower")){
